import { createIcons, Folder, FolderOpen, File, ChevronRight, Plus, X, Circle, CircleDot, Disc, Trash2, Pin, MessageSquare, Search, Minus, Square } from "lucide";
...
export const ICONS = { Folder, FolderOpen, File, ChevronRight, Plus, X, Circle, CircleDot, Disc, Trash2, Pin, MessageSquare, Search, Minus, Square };
