const dict: Record<string, Record<string, string>> = {
  en: {
    ...
    "settings.ai_help": "OpenAI-compatible providers are supported. Model loading uses GET /models on the configured Base URL. If the URL has no version path, Shelf also tries /v1.",
  ...
  zh: {
    ...
    "settings.ai_help": "支持 OpenAI 兼容服务。模型加载会在配置的 Base URL 上请求 GET /models；如果地址没有版本路径，Shelf 也会尝试 /v1。",
