const dict: Record<string, Record<string, string>> = {
  en: {
    ...
    "settings.cli_help": "Extra arguments are applied to every new or resumed local/SSH session. Enter arguments only, without the claude or codex executable name. The live preview shows the final local argv in a readable shell form.",
  ...
  zh: {
    ...
    "settings.cli_help": "额外参数会用于每次新建或恢复的本地/SSH 会话。这里只填写参数，不要包含 claude 或 codex 命令名；下方会以便于阅读的 shell 形式实时预览最终本地 argv。",
