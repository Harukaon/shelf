const dict: Record<string, Record<string, string>> = {
  en: {
    ...
    "settings.terminal_theme": "Terminal Theme",
    "settings.theme_preset": "Preset",
    "settings.theme_preset.comfort": "Shelf Comfort",
    "settings.theme_preset.mac": "macOS Terminal",
    "settings.theme_preset.custom": "Custom",
    "settings.theme_background": "Background",
    "settings.theme_foreground": "Text",
    "settings.theme_cursor": "Cursor",
    "settings.theme_selection": "Selection",
    "settings.theme_preview": "Preview text",
    "settings.save": "Save",
  ...
  zh: {
    ...
    "settings.terminal_theme": "终端配色",
    "settings.theme_preset": "预设",
    "settings.theme_preset.comfort": "Shelf 舒适",
    "settings.theme_preset.mac": "macOS 终端",
    "settings.theme_preset.custom": "自定义",
    "settings.theme_background": "背景",
    "settings.theme_foreground": "文字",
    "settings.theme_cursor": "光标",
    "settings.theme_selection": "选区",
    "settings.theme_preview": "预览文字",
    "settings.save": "保存",
    "settings.cancel": "取消",
