...
- At least one supported CLI installed and accessible in your PATH: [Claude Code](https://docs.anthropic.com/en/docs/claude-code), [Codex](https://github.com/openai/codex), or [pi](https://pi.dev)
